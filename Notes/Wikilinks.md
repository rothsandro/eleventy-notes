...
Use Wikilinks to create links to other notes. They will automatically be converted to the correct URL. Wikilinks are case-insensitive and can contain spaces. You will see all incoming links (aka backlinks) to a note in the [[Panel]] on the right.
...
If you want to link to a specific note in a folder, include the folder (or all folders if nested):
...
A label will automatically be generated from the provided reference if you omit the label. You can customize the behavior in your [[Configuration File|configuration]]:
