...
- 📦️ **Dependencies**: Updated dependencies and reduced installation size.
- 🐛 **Bugfixes**: Fixed HTML issues, collapsible folders, styling and types.
- 📝 **Docs**: Restructured and improved documentation.
